...
export class Header extends Component {
    render() {
        return (
            <div>
                <nav className="navbar navbar-expand-lg" style={{backgroundColor:"#6C3483"}}>
                    <div className="container-fluid ">

                        <select className="form-select form-select-lg " aria-label=".form-select-lg example" name='selectCoin'
                            style={{ width: "fit-content", color:"#5499C7" }} onChange={this.props.handle_Submit}>
                        ...
                        <a className="navbar-brand d-flex ml-auto display-2  fs-2 fw-bold text-uppercase "
                            style={{ fontFamily: 'NHaasGroteskDSPro-65Md',color:"#76D7C4" }} href="/">Crypto 
                            Dashboard</a>
